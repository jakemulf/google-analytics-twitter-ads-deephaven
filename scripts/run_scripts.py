...
def main(script_paths: list, host: str, port: int, max_retries: int):
    """
    ...
    Parameters:
        ...
        port (int): The port of the Deephaven instance
...
usage = """
usage: python run_script.py script-paths host port max-retries
"""
...
if __name__ == '__main__':
    ...
    main(script_paths, host, port, max_retries)
